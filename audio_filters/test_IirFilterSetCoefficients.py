...
class Test_IirFilterSetCoefficients:
    ...
    def test_set_coefficients_lesser_order(self):
        # Arrange
        order = 3
        a_coeffs = [1.0, 0.5, 0.25, 0.125]  # Changed a_coeffs to have 4 elements
    ...
    def test_set_coefficients_prepends_one(self):
        # Arrange
        order = 2
        a_coeffs = [0.5, 0.25]  # a_coeffs has 2 elements, 1.0 will be prepended in the set_coefficients method
        b_coeffs = [1.0, 0.5, 0.25]
        filter = IIRFilter(order)
