...
class Test_ButterworthFilterMakePeak:
    def test_make_peak_correct_coefficients(self):
        ...
        assert filter.a_coeffs == [1.0, -1.9828897227476208, 0.9346594672880666]
    ...
    def test_make_peak_zero_gain(self):
        ...
        assert isinstance(filter, IIRFilter)
        assert filter.a_coeffs == [1.0, -1.9828897227476208, 0.9346594672880666]
        assert filter.b_coeffs == [1.0, -1.9828897227476208, 0.9346594672880666]
    ...
    def test_make_peak_negative_gain(self):
        ...
        assert isinstance(filter, IIRFilter)
        assert filter.a_coeffs == [1.0, -1.9828897227476208, 0.9346594672880666]
        assert filter.b_coeffs == [0.8696284974398878, -1.9828897227476208, 1.0653405327119334]
    ...
    def test_make_peak_zero_frequency(self):
        ...
        assert filter.b_coeffs == [1.0, -2.0, 1.0]
