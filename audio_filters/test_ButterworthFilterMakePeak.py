...
class Test_ButterworthFilterMakePeak:
    def test_make_peak_correct_coefficients(self):
        ...
        # The coefficients are dependent on the input parameters, so they need to be calculated, not hardcoded.
    ...
    def test_make_peak_zero_gain(self):
        ...
        assert filter.b_coeffs == [1.0922959556412573, -1.9828897227476208, 0.9077040443587427]
